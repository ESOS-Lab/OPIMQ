...
// default region size
#define JOURNAL_REGION 128     // in MB
//#define JOURNAL_REGION 10240     // in MB
...
#ifdef USE_AEP
unsigned int NVM_FLUSH(u64 start, u64 size);
#endif
...
/* debug */
extern u64 stream_get_olayer_nsec(uint sid);
extern u64 stream_get_pmr_nsec(uint sid);
extern u64 stream_get_chkpt_nsec(uint sid);
extern u64 stream_get_olayer_msec(uint sid);
extern u64 stream_get_pmr_msec(uint sid);
extern u64 stream_get_chkpt_msec(uint sid);
extern int stream_get_chkpt_num(uint sid);
