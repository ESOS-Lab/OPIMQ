...
#define IFLOOP_DEBUG				(0)
#define PRINT_DEBUG				(0)
#define PRINT_DEBUG_MAP				(0)
#define PRINT_DEBUG_SP				(0)
#define BARRIER_IN_DMA 				(1)
...
#define INVALID_CMD_SLOT_TAG		(0xFFFF)
...
#define NVME_OPC_ADMIN_DELETE_IO_SQ									0x00
#define NVME_OPC_ADMIN_CREATE_IO_SQ									0x01
#define NVME_OPC_ADMIN_GET_LOG_PAGE									0x02
#define NVME_OPC_ADMIN_DELETE_IO_CQ									0x04
...
#define NVME_OPC_ADMIN_ASYNCHRONOUS_EVENT_REQUEST					0x0C
#define NVME_OPC_ADMIN_FIRMWARE_ACTIVATE							0x10
#define NVME_OPC_ADMIN_FIRMWARE_IMAGE_DOWNLOAD						0x11
#define NVME_OPC_ADMIN_FORMAT_NVM									0x80
#define NVME_OPC_ADMIN_DOORBELL_BUFFER_CONFIG						0x7C
#define NVME_OPC_ADMIN_SECURITY_SEND								0x81
#define NVME_OPC_ADMIN_SECURITY_RECEIVE								0x82

/*Opcodes for IO Commands */
#define NVME_OPC_NVM_FLUSH										0x00
#define NVME_OPC_NVM_WRITE										0x01
#define NVME_OPC_NVM_READ											0x02
#define NVME_OPC_NVM_WRITE_UNCORRECTABLE							0x04
#define NVME_OPC_NVM_COMPARE										0x05
#define NVME_OPC_NVM_DATASET_MANAGEMENT							0x09
...
#define FID_POWER_STATE_TRANSITION								0x0C
#define FID_TIMESTAMP											0x0E
...
typedef struct _NVME_IO_COMMAND
{
	union {
		...
		struct {
			...
			unsigned int NSID;
//JW#if (SUPPORT_BARRIER_FTL == 1)
			struct {
				unsigned short stream_id_1;
				unsigned short stream_id_2;
				unsigned short epoch_id_1;
				unsigned short epoch_id_2;
			};
//JW#else
//JW			unsigned int reserved1[2];
//JW#endif //#if (SUPPORT_BARRIER_FTL == 1)
			unsigned int MPTR[2];
			unsigned int PRP1[2];
			unsigned int PRP2[2];
			unsigned int dword10;
...
typedef struct _IO_WRITE_COMMAND_DW12
{
	union {
		...
		struct {
			...
			unsigned short barrier_flag				:1;			// SP: be set this flag if barrier write of stream id 1
#else
