...
#define	MAIN_BLOCKS_PER_LUN			5464//2732
#define EXTENDED_BLOCKS_PER_LUN		452//224
...
#define	USER_BLOCKS_PER_LUN		4096//2048		//user configurable factor
...
typedef struct _ftl_context
{
	XTime start_tick_internal_flush;
	XTime end_tick_internal_flush;
} ftl_context;
