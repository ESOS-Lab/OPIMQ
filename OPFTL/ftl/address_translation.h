...
unsigned int AddrTransSuspen(unsigned int logicalSliceAddr); //Jieun add
void UpdateAddrWrite(unsigned int logicalSliceAddr, unsigned int virtualSliceAddr); //Jieun add
